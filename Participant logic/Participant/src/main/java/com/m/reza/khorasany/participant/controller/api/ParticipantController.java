package com.m.reza.khorasany.participant.controller.api;
...
public interface ParticipantController {
    ...
    ResponseEntity<ParticipantOutputDto> findById(@PathVariable final Integer id);
    ...
    ResponseEntity<?> update(@PathVariable final Integer id, @RequestBody final Map<String, Object> values);
